...
namespace DoAnTotNghiep.Data
{
    public static class SeedIdentity
    {
        public static async Task SeedRolesAndAdminAsync(IServiceProvider services)
        {
            ...
            var adminEmail = "admin@kbhome.com";
            ...
            await CreateUserIfNotExists(userManager, logger, "purchasing@kbhome.com", "Password123!", "Purchasing");
            await CreateUserIfNotExists(userManager, logger, "warehouse@kbhome.com", "Password123!", "Warehouse");
            await CreateUserIfNotExists(userManager, logger, "sales@kbhome.com", "Password123!", "Sales");
            await CreateUserIfNotExists(userManager, logger, "logistics@kbhome.com", "Password123!", "Logistics");
        }
