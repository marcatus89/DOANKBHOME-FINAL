...
namespace DoAnTotNghiep.Migrations
{
    ...
    [Migration("20251006134528_AddOldQtyAndUserEmailToInventoryLog")]
    partial class AddOldQtyAndUserEmailToInventoryLog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoAnTotNghiep.Models.Location", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DoAnTotNghiep.Models.StockLevel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DoAnTotNghiep.Models.Warehouse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DoAnTotNghiep.Models.Location", b =>
                {
                    b.HasOne("DoAnTotNghiep.Models.Warehouse", "Warehouse")
                        .WithMany("Locations")
            ...
            modelBuilder.Entity("DoAnTotNghiep.Models.StockLevel", b =>
                {
                    b.HasOne("DoAnTotNghiep.Models.Location", "Location")
                        .WithMany()
                    ...
                    b.HasOne("DoAnTotNghiep.Models.PurchaseOrderItem", "PurchaseOrderItem")
                        .WithMany()
